...
public class AParkingLot2 extends AppCompatActivity {
    DatabaseHelper db;
    Button B1, B2, B3, B4, B5, B6, B7, B8, B9, B10, B11, B12, Lock, Unlock;
    final int[] slot = {0};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_adminparking2);
        ...
        Lock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                db.lock2(slot[0]);
                Toast.makeText(AParkingLot2.this, "Slot Restricted", Toast.LENGTH_LONG).show();
            }
        });
        Unlock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                db.unlock2(slot[0]);
                Toast.makeText(AParkingLot2.this, "Slot Released", Toast.LENGTH_LONG).show();
            }
        });
    }
}
